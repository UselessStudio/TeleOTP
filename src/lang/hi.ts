export const lang = {
    ...
    ShowAdjacentCodes: "आस-पास के कोड दिखाएँ",
    ActionOpen: "खोलें",
    ...
    ExportAccountsText:
        "आप TeleOTP का उपयोग करके खातों को लिंक से निर्यात कर सकते हैं, या Google Authenticator (या इसी तरह) में QR कोड का उपयोग कर सकते हैं।",
    ...
    LinkExportSecretWarning:
        "इसे गोपनीय रखें! कोई भी इस लिंक का उपयोग करके आपके कोड्स तक पहुंच सकता है।",
    QRExportDescription:
        "आप Google Authenticator या TeleOTP में अपने खातों को QR कोड स्कैन करके आयात कर सकते हैं।",
    ...
    DecryptDescription:
        "अपने खातों तक पहुंच प्राप्त करने के लिए अपना डिक्रिप्शन पासवर्ड दर्ज करें",
    ...
    NewAccountDescription:
        "अपने खाते को दो-कारक प्रमाणीकरण के साथ सुरक्षित करें (Google Authenticator आयात भी समर्थित है)",
    ...
    PasswordSetupDescription:
        "अपने खातों को सुरक्षित रूप से संग्रहीत करने के लिए एक नया एन्क्रिप्शन पासवर्ड दर्ज करें",
    ...
    DeleteWarning:
        "आप स्थायी रूप से अपने सभी खातों को हटाने वाले हैं। आप उन्हें पुनर्स्थापित नहीं कर पाएंगे।",
    TypeDeleteConfirmationPhrase:
        "यदि आप पूरी तरह से सुनिश्चित हैं, तो वाक्यांश टाइप करें",
